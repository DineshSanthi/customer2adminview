...
public class TableItemDetailTabPane extends AbstractTabPane {
	...
	public TableItemDetailTabPane(final DataSource appRestDS, final DataSource tableDS, final DataSource tableScriptDS,
		...
		SelectItem appName = new SelectItem("appName");
		appName.setTitle(Constants.appNameLabel());
		appName.setWidth(240);
		appName.setOptionDataSource(appRestDS);
		appName.setValueField("appName");
		appName.setDisplayField("appName");
		appName.setPickListWidth(450);
		...
		orderForm.setFields(appId, appName, tableName, tableDesc, descTamil, descTelugu, category, ttl);
