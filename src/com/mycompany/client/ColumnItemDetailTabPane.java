...
public class ColumnItemDetailTabPane extends AbstractTabPane {
    ...
    public ColumnItemDetailTabPane(DataSource objectDS,DataSource tableRestDS,DataSource referenceDS,DataSource columnTypeDS,DataSource defaultDataDS,final ColumnScriptRestDS columnScriptDS, ResultsLayout resultsLayout, final ListGrid resultsListGrid) {
       ...
       // columnType.setDisplayField("refId");
        ...
        orderForm.setFields(appId, tableName, columnName,columnDesc,descTamil,descTelugu,category,columnType,referenceData,columnSize,required,disabled,hidden,readOnly); 
